...
/**
 * @deprecated tag:v6.8.0 - Will be removed in 6.8.0. Use HeyFrame\Core\Framework\Notification\NotificationDefinition instead
 */
#[Package('framework')]
class NotificationDefinition extends EntityDefinition
{
    ...
    {
        Feature::triggerDeprecationOrThrow('v6.8.0.0', Feature::deprecatedClassMessage(self::class, 'v6.8.0.0', \HeyFrame\Core\Framework\Notification\NotificationEntity::class));
