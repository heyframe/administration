...
const sliderItemsConfigMock = [
    {
        mediaId: '1',
        mediaUrl: 'http://heyframe.net/image1.jpg',
    },
    {
        mediaId: '2',
        mediaUrl: 'http://heyframe.net/image2.jpg',
    },
    {
        mediaId: '3',
        mediaUrl: 'http://heyframe.net/image3.jpg',
    },
];
...
const sliderItemsDataMock = [
    {
        media: {
            id: '1',
            url: 'http://heyframe.net/image1.jpg',
        },
    },
    {
        media: {
            id: '2',
            url: 'http://heyframe.net/image2.jpg',
        },
    },
    {
        media: {
            id: '3',
            url: 'http://heyframe.net/image3.jpg',
        },
    },
];
...
describe('src/module/sw-cms/elements/image-slider/component', () => {
    ...
    it('setSliderArrowItem should work correctly', async () => {
        ...
        expect(wrapper.vm.imgSrc).toBe('http://heyframe.net/image1.jpg');
        ...
        expect(wrapper.vm.imgSrc).toBe('http://heyframe.net/image3.jpg');
        ...
        expect(wrapper.vm.imgSrc).toBe('http://heyframe.net/image2.jpg');
    });
