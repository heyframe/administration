...
HeyFrame.Component.register('sw-manufacturer-list', () => import('./page/sw-manufacturer-list'));
HeyFrame.Component.register('sw-manufacturer-detail', () => import('./page/sw-manufacturer-detail'));
