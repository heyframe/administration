...
export default {
    ...
    methods: {
        async createdComponent() {
            ...
            this.tagCollection = new EntityCollection('/tag', 'tag', HeyFrame.Context.api, new Criteria(1, 25));
            ...
            try {
                const [
                    ...
                    this.repositoryFactory.create('language').search(criteria, HeyFrame.Context.api),
