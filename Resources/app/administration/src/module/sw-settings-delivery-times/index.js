...
HeyFrame.Component.register('sw-settings-delivery-time-list', () => import('./page/sw-settings-delivery-time-list'));
HeyFrame.Component.register('sw-settings-delivery-time-detail', () => import('./page/sw-settings-delivery-time-detail'));
