...
HeyFrame.Component.register('sw-settings-listing', () => import('./page/sw-settings-listing'));
HeyFrame.Component.register('sw-settings-listing-option-base', () => import('./page/sw-settings-listing-option-base'));
