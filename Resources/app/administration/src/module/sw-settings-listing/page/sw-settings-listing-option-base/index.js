    ...
    methods: {
        ...
        fetchProductSortingEntity() {
            ...
            this.productSortingRepository
                .get(productSortingEntityId, HeyFrame.Context.api, this.productSortingEntityCriteria)
                .then((response) => {
        ...
        async isValidSortingOption() {
            if (!this.productSortingEntity.key) {
                this.sortingOptionTechnicalNameError = new HeyFrameError({
            ...
            if (!this.productSortingEntity.label) {
                this.sortingOptionLabelError = new HeyFrameError({
                    code: 'c1051bb4-d103-4f74-8988-acbcafc7fdc3',
                });
            }
