...
export default {
    ...
    computed: {
        ...
        measurementUnitSystemError() {
            ...
            return HeyFrame.Store.get('error').getApiError(this.measurementSystem, 'system');
        },
        ...
        measurementLengthUnitError() {
            ...
            return HeyFrame.Store.get('error').getApiError(this.measurementSystem, 'length');
        },
        ...
        measurementWeightUnitError() {
            ...
            return HeyFrame.Store.get('error').getApiError(this.measurementSystem, 'weight');
        },
    },
