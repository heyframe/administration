...
HeyFrame.Component.register('sw-settings-salutation-list', () => import('./page/sw-settings-salutation-list'));
HeyFrame.Component.register('sw-settings-salutation-detail', () => import('./page/sw-settings-salutation-detail'));
