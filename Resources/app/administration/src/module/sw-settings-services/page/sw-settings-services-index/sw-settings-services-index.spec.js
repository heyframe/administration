...
describe('/src/module/sw-setting-services/page/sw-settings-services-index', () => {
                ...
                'available-revisions': [
                    {
                        revision: '2025-06-25',
                        links: {
                            'feedback-url': 'https://heyframe.net/feedback',
                            'docs-url': 'https://docs.heyframe.net/services',
                            'tos-url': 'https://heyframe.net/agb',
                        },
                    },
                ],
            })),
    ...
    it('shows installed services', async () => {
        ...
        expect(hero.props('documentationLink')).toBe('https://docs.heyframe.net/services');
        expect(hero.props('feedbackLink')).toBe('https://heyframe.net/feedback');
    ...
    it('shows correct links in the footer', async () => {
        ...
        expect(documentationLink.attributes('href')).toBe('https://docs.heyframe.net/services');
        expect(tosLink.attributes('href')).toBe('https://heyframe.net/agb');
    });
