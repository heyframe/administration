...
describe('module/sw-settings-shipping/component/sw-settings-shipping-price-matrices', () => {
    ...
    beforeEach(async () => {
        ...
        const shippingMethod = HeyFrame.Store.get('swShippingDetail').shippingMethod;
    ...
    it('should add the shipping price group', async () => {
        ...
        HeyFrame.Store.get('swShippingDetail').shippingMethod.prices.add = (value) => {
            HeyFrame.Store.get('swShippingDetail').shippingMethod.prices.push(value);
        };
