...
export default {
    ...
    computed: {
        ...
        unrestrictedPriceMatrixExists() {
            return HeyFrame.Store.get('swShippingDetail').unrestrictedPriceMatrixExists;
        },

        newPriceMatrixExists() {
            return HeyFrame.Store.get('swShippingDetail').newPriceMatrixExists;
        },

        defaultCurrency() {
            return HeyFrame.Store.get('swShippingDetail').defaultCurrency;
        },
