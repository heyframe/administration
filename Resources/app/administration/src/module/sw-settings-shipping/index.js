...
HeyFrame.Component.register('sw-settings-shipping-list', () => import('./page/sw-settings-shipping-list'));
HeyFrame.Component.register('sw-settings-shipping-detail', () => import('./page/sw-settings-shipping-detail'));
HeyFrame.Component.extend('sw-price-rule-modal', 'sw-rule-modal', () => import('./component/sw-price-rule-modal'));
...
HeyFrame.Component.register('sw-settings-shipping-tax-cost', () => import('./component/sw-settings-shipping-tax-cost'));
