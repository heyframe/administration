...
export default {
    ...
    methods: {
        ...
        isHeyFrameDefaultTax(tax) {
            return this.$te(`global.tax-rates.${tax.name}`, 'en-GB');
        },

        getLabel(tax) {
            return this.isHeyFrameDefaultTax(tax) ? this.$tc(`global.tax-rates.${tax.name}`) : tax.name;
        },
        ...
        onChangeTaxProviderActive(taxProvider) {
            ...
            this.taxProviderRepository.save(taxProvider, HeyFrame.Context.api).then(() => {
