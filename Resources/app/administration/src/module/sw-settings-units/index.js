...
HeyFrame.Component.register('sw-settings-units-list', () => import('./page/sw-settings-units-list'));
HeyFrame.Component.register('sw-settings-units-detail', () => import('./page/sw-settings-units-detail'));
