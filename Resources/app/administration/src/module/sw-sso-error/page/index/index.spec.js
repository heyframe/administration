...
describe('src/module/sw-sso-error/page/index', () => {
    ...
    it('should load the heyframe logo', async () => {
        const wrapper = await createWrapper(false);
        await flushPromises();

        const heyframeLogo = wrapper.get('.sw-sso-error__image-container > img');

        expect(heyframeLogo.attributes('src')).toBe('administration/administration/static/img/heyframe_logo_blue.svg');
    });
